     ...
     <div class="col-xl-12">
         <div class="card">
             <div class="card-body">
				 ...
				 <h4 class="box-title2"><a href="order__Rejected.php"> < Order </a></h4>
             ...
             <table class="table">
                ...
                <div id="address_details">
							...
							<div>
                            <?php 
                        $seller_res=mysqli_query($con,"select order_review.msg,seller.name from seller,order_review where order_review.order_id='$order_id'");
                        $seller_row=mysqli_fetch_assoc($seller_res);   ?><br>
